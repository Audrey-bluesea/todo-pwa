...
export default function CalendarWeekCards() {
  ...
  return (
    <div className="scroll-y h-full px-3 pb-[calc(var(--tabbar-h)+var(--sab)+16px)] pt-2">
        ...
        {days.map((d, i) => {
          ...
          return (
            <div
              ...
              className={`flex min-h-[132px] flex-col rounded-lg bg-white p-2.5 shadow-card-soft ${
